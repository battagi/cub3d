	...
	/*   Updated: 2025/02/06 08:18:32 by abattagi         ###   ########.fr       */
	/*                                                                            */
	/* ************************************************************************** */
	...
	void    player_movement(t_game *data)
{
	...
	void	draw_map(t_game *data)
	{
		...
		draw_circle(data->textures->image, data->player->pos_x, data->player->pos_y,
			5, COLOR_PLAYER);
		draw_line(data->textures->image, data->player->pos_x, data->player->pos_y,
			data->player->pos_x + cos(data->player->dir) * 30,
			data->player->pos_y + sin(data->player->dir) * 30);
	}
